...
const baseStatus = { network_id:"zion-alpha-1", genesis_id:"00", runtime_state:"RUNNING", roles:["NORMAL"], peer_id:"peer", sync_status:"SYNCED", accepted_height:7, state_hash:"state", consensus_active:false, validator_authorized:false, protocol_version:"0.1", object_store_enabled:true, object_count:0, object_bytes:0, object_quota_bytes:100, board_enabled:true, indexed_posts:0, indexed_replies:0, hidden_local:0, board_sync_state:"ACTIVE" };
